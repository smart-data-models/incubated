...
mypath = './'  # Replace with the path of your current directory
...
for file in files:
    ...
    if dataModel not in exceptions and counter < limit:
        ...
        # Remember to change the schema.json file path
        origin = "https://raw.githubusercontent.com/smart-data-models/incubated/master/SMARTLOGISTICS/TRAINS/dataModel.ERA/" + dataModel + "/schema.json"
        print(origin)
        ...
        if "@context" in exampleLDKeyvalues:
            exampleLDKeyvalues["@context"] = ["https://raw.githubusercontent.com/smart-data-models/dataModel.ERA/master/context.jsonld"]
            exampleLDNormalized["@context"] = [
