.. image:: https://smartdatamodels.org/wp-content/uploads/2022/01/SmartDataModels_logo.png
   :target: https://smartdatamodels.org
   :alt: Smart Data Models
...
Each data model follows the Smart Data Models standard structure::
    ...
    ├── ADOPTERS.yaml           # List of adopters
    └── examples/
...
- `Smart Data Models <https://smartdatamodels.org/>`_
- `ROS2 Documentation <https://docs.ros.org/>`_
- `FIWARE NGSI-LD <https://www.etsi.org/deliver/etsi_gs/CIM/001_099/009/01.04.01_60/gs_cim009v010401p.pdf>`_
- `ROS2 Message Types <http://docs.ros.org/en/rolling/Concepts/About-ROS-Interfaces.html>`_
